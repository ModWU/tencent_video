...
class DgnTab extends StatelessWidget {
...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /*final TextPainter changeTextPainter = new TextPainter(
        text: TextSpan(style: textStyle), textDirection: TextDirection.ltr);
    changeTextPainter.layout();
    final double changeTextDistanceToActualBaseline =
        changeTextPainter.computeDistanceToActualBaseline(
            defaultStyle.textBaseline ?? TextBaseline.alphabetic);*/
    ...
    final double scaleValue = percent;
    final Matrix4 transform = Matrix4.identity()
      ..scale(scaleValue, scaleValue, 1.0);
    final Widget result = Transform(
      transform: transform,
...
class DgnTabBar extends StatefulWidget implements PreferredSizeWidget {
...
class _TabBarState extends State<DgnTabBar> {
  ...
  @override
  void didUpdateWidget(DgnTabBar oldWidget) {
  ...
  void _scrollToCurrentIndex() {
    ...
    _scrollController!
        .animateTo(offset, duration: widget.duration, curve: Curves.ease);
  }
  ...
  void _handleTap(int index) {
    ...
    _controller!.animateTo(index, duration: widget.duration);
...
class DgnTabBarView extends StatefulWidget {
...
class _TabBarViewState extends State<DgnTabBarView> {
  TabController? _controller;
  ...
  @override
  void didUpdateWidget(DgnTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
...
class DgnTabPageSelectorIndicator extends StatelessWidget {
  /// Creates an indicator used by [TabPageSelector].
  ///
  /// The [backgroundColor], [borderColor], and [size] parameters must not be null.
  const DgnTabPageSelectorIndicator({
    Key? key,
...
/// If a [TabController] is not provided, then there must be a
/// [DefaultTabController] ancestor.
class DgnTabPageSelector extends StatelessWidget {
  /// Creates a compact widget that indicates which tab has been selected.
  const DgnTabPageSelector({
    Key? key,
    this.controller,
  ...
  Widget _buildTabIndicator(
    ...
    return DgnTabPageSelectorIndicator(
